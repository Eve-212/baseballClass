...
module.exports = configure(function (/* ctx */) {
  return {
    ...
    // https://v1.quasar.dev/quasar-cli/quasar-conf-js#css
    css: ['app.scss'],
    ...
    // Full list of options: https://v1.quasar.dev/quasar-cli/quasar-conf-js#build
    build: {
      target: {
      ...
      //   ['vite-plugin-checker', {
      //     eslint: {
      //       lintCommand: 'eslint -c ./eslint.config.mjs "./src*/**/*.{js,mjs,cjs,ts,vue}"',
      //     },
      //   }, { server: false }],
      // ],
    },
