  ...
  community: [
    {
      type: 'text',
      text: `✍️社區棒球班，課程特色
      \n▪︎福岡軟銀鷹官方授權，由亞洲區球探李杜軒教練親自帶領
      \n▪︎前職棒明星教練團專業指導
      \n▪︎帶領小朋友體驗棒球樂趣，培養團隊合作
      \n▪︎提供軟銀同款球衣與練習裝
      \n▪︎優先報名寒暑假限定活動（赴日交流、觀賽、參訪訓練設施）
      \n▪︎表現優異者，有機會獲得現役球員球具
      \n📍上課時間/ 地點
      \n▪︎訓練日：週日 9:00-12:00 (萬華龍山國小/ 天母棒球場，視中職賽程調整)
      \n▪︎比賽日：配合比賽時間及地點
      \n💰課程費用
      \n▪︎單期：$4,000（4堂）
      \n▪︎優惠價：3個月 $3,800／6個月 $3,600（每期）
      \n▪︎超值包含：球衣、球褲、球帽、練習衣、帽T、訓練時飲用水`
    },
  ...
  personal: [
    {
      type: 'text',
      text: `✍️個人菁鷹班，課程特色
        \n▪︎福岡軟銀鷹官方授權，亞洲區球探李杜軒教練親自指導
        \n▪︎導入日職一軍訓練系統，依學員狀況客製調整
        \n▪︎提供升學、赴日與職棒發展規劃
        \n▪︎全方位訓練：打擊｜守備｜跑壘｜投球｜體能｜重訓｜棒球觀念
        \n📍上課時間/地點
        \n▪︎08:00–22:00（時段彈性安排）
        \n▪︎新北蘆洲 LBC 棒球訓練基地（可另行商議）
        \n💰課程費用
        \n▪︎單堂：$2,500／hr（含場地費）
        \n▪︎10–20堂：$2,300／堂
        \n▪︎20堂以上：$2,000／堂
